...
> **EN:** A full-stack Warehouse Management System built with Node.js (NestJS), PostgreSQL, and React — covering materials, stock, procurement, tools, and analytics in one platform.
>
> **TH:** ระบบจัดการคลังสินค้าแบบครบวงจร สร้างด้วย Node.js (NestJS), PostgreSQL และ React ครอบคลุมทั้งวัสดุ สต็อก จัดซื้อ เครื่องมือ และ Analytics
...
┌─────────────────────────────────────────────────────┐
│                    Client (React)                    │
│         Vue.js SPA  ·  Barcode Scanner UI           │
└────────────────────┬────────────────────────────────┘
                     │ HTTPS / REST
┌────────────────────▼────────────────────────────────┐
│               API Server (NestJS)                    │
│                                                      │
│  Auth (JWT)  ·  Guards (RBAC)  ·  Pipes (Validation) │
│                                                      │
│  Modules:                                            │
...
```
warehouseos/
├── warehouse-api/              # NestJS Backend
│   ├── src/
│   │   ├── auth/               # JWT Auth, Guards
│   │   ├── users/              # Users & Departments
│   │   ├── materials/          # Materials & Categories
│   │   ├── warehouses/         # Warehouses & Locations
│   │   ├── stock/              # Stock, Transactions, Counts
│   │   ├── procurement/        # PO, GR, Material Issues
│   │   ├── tools/              # Tools, Borrow Records
│   │   ├── suppliers/          # Suppliers
│   │   ├── dashboard/          # Analytics
│   │   ├── barcode/            # QR / Barcode
│   │   ├── pdf/                # PDF Export
...
│   └── package.json
│
├── warehouse-frontend/         # React Frontend
│   ├── src/
│   │   ├── pages/
│   │   ├── components/
│   │   ├── services/           # API calls
